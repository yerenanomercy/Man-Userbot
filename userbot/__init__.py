...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "Userbot-Man")

# Bot version
BOT_VER = os.environ.get("BOT_VER", "4.1")
...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "```🔥✘ Userbot-Man Berhasil Di Aktifkan ✘🔥```")
    return
    ...
    try:
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # pylint:disable=E0602
                ...
                reply_pop_up_alert = f"Harap Deploy Userbot Sendiri, Jangan Menggunakan Milik {ALIVE_NAME} ツ"
