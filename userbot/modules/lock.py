...
async def locks(event):
    ...
    try:
        ...
        await event.edit(f"`masater Telah Mengunci {what} Untuk Obrolan Ini ヅ`")
...
async def rem_locks(event):
    ...
    try:
        ...
        await event.edit(f"`Master Telah Membuka Kunci {what} Untuk Obrolan Ini ヅ`")
    except BaseException as e:
        await event.edit(
            f"`Apakah Mempunyai Izin Melakukan Itu Disini?`\n**Kesalahan:** {str(e)}"
        )
        return
